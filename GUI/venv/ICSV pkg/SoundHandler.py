...
class WAV_Header():
  def __init__(self):
    ...
    self.FMT = namedtuple('Coordinate',
                          ['ChunkID', 'ChunkSize', 'AudioFormat', 'NumChannels', 'SampleRate', 'AvgByteRate',
...
class Sound():
  ...
  def WriteWav_Mono(self, filename, value_count, value):
    ...
    with open(filename, 'wb') as write_file:
      ...
      write_file.write(
        (36 + bytes_per_sample * num_channels * value_count).to_bytes(4, byteorder='little', signed=False))
